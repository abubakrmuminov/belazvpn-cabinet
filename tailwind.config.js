  ...
  theme: {
    extend: {
      colors: {
        ...
        // BELAZ Industrial named tokens — for text-industrial-yellow etc.
        'industrial-yellow': '#F4C542',
        'industrial-black':  '#1F1F1F',
        'industrial-steel':  '#3E4349',
        'industrial-silver': '#A4A9AD',
        'industrial-graphite': '#2B2B2B',
      },
      fontFamily: {
        sans: [
        ...
        display: ['Twemoji Country Flags', 'Inter', 'Roboto Condensed', 'system-ui', 'sans-serif'],
