  ...
  return (
    <Shell>
      <div className="text-center">
        ...
        <div className="mb-6 space-y-2 rounded-none border border-dark-800 bg-dark-900 p-4 text-left text-sm">
        ...
        {redeemError && (
          <div className="mb-4 rounded-none border border-error-500/30 bg-error-500/10 p-3 text-sm text-error-400">
            {redeemError}
          </div>
        )}
