    ...
    return (
      <div className="min-h-viewport flex items-center justify-center px-4 py-8">
        ...
        <div className="relative w-full max-w-md text-center">
          <div className="card">
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-none bg-success-500/20">
            ...
            {telegramLink && (
              <a
                href={telegramLink}
                className="btn-primary inline-block w-full rounded-none bg-accent-500 px-6 py-3 text-center font-medium text-dark-950 no-underline transition-colors hover:bg-accent-400"
              >
  ...
  if (error) {
    ...
    return (
      <div className="min-h-viewport flex items-center justify-center px-4 py-8">
        ...
        <div className="relative w-full max-w-md text-center">
          <div className="card">
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-none bg-error-500/20">
