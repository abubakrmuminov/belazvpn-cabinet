  ...
  return (
    <div className="min-h-viewport flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm text-center">
        ...
        <div className="mx-auto mb-6 flex h-20 w-20 animate-pulse items-center justify-center overflow-hidden rounded-none bg-gradient-to-br from-accent-400 to-accent-600 shadow-lg shadow-accent-500/30">
        ...
        {status === 'countdown' && (
          <div className="card !bg-dark-800/80 p-6 backdrop-blur-sm">
            {/* App icon */}
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-none bg-accent-500/20">
        ...
        {status === 'fallback' && (
          <div className="card !bg-dark-800/80 p-6 backdrop-blur-sm">
            ...
            {/* Instructions */}
            <div className="mt-6 rounded-none border border-dark-700 bg-dark-900/50 p-4 text-left">
