...
function CopyableField({ label, value }: { label: string; value: string }) {
  ...
  return (
    <div className="flex items-center gap-2 rounded-none bg-dark-800/50 px-4 py-3">
      ...
      <button
        ...
        onClick={handleCopy}
        className={cn(
          'shrink-0 rounded-none px-3 py-1.5 text-xs font-medium transition-colors',
          copied
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          'flex w-full items-center justify-center gap-2 rounded-none px-6 py-3 text-sm font-medium text-white transition-colors',
    ...
    >
      ...
      {isGift && contactType === 'telegram' && recipientInBot !== true && botLink && (
        <a
          ...
          className="flex w-full items-center justify-center gap-2 rounded-none bg-accent-500 px-6 py-3 text-sm font-medium text-on-accent transition-colors hover:bg-accent-400"
        >
          {t('landing.openBot')}
        </a>
      )}
      ...
      {displayUrl && (
        <div className="space-y-4">
          ...
          <button
            ...
            onClick={handleCopy}
            className={cn(
              'flex w-full items-center justify-center gap-2 rounded-none px-4 py-3 text-sm font-medium transition-all duration-200',
              copied
                ? 'bg-success-500/10 text-success-500'
    ...
    >
      ...
      <div className="flex w-full flex-col gap-3">
        <button
          ...
          className={cn(
            'flex items-center justify-center gap-2 rounded-none px-6 py-3 text-sm font-medium text-white transition-colors',
            isActivating
        ...
        {autoLoginToken && (
          <button
            ...
            disabled={isLoggingIn}
            className={cn(
              'flex items-center justify-center gap-2 rounded-none px-6 py-3 text-sm font-medium transition-colors',
              isLoggingIn
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onRetry}
        className="rounded-none bg-accent-500 px-6 py-3 text-sm font-medium text-on-accent transition-colors hover:bg-accent-400"
      >
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={handleCopy}
        className={cn(
          'flex w-full items-center justify-center gap-2 rounded-none px-4 py-3.5 text-sm font-bold transition-all duration-200 active:scale-[0.98]',
          copied
...
export default function PurchaseSuccess() {
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-dark-950 px-4">
      <div
        className="w-full max-w-md rounded-none border border-dark-800/50 bg-dark-900/50 p-8"
        aria-live="polite"
        aria-atomic="true"
      >
        {isError ? (
