    ...
    return (
      <div className="mx-auto max-w-lg p-4 text-center">
        ...
        <button
          ...
          className="rounded-none bg-accent-500 px-6 py-2.5 text-sm font-medium text-on-accent"
        >
  ...
  return (
    <div className="space-y-6">
      ...
      {subscription ? (
            ...
            >
              ...
              {subscription.subscription_url && (
                <HoverBorderGradient
                  ...
                  className={`mb-5 flex w-full items-center gap-3.5 rounded-none p-3.5 text-left transition-shadow duration-300${isAtDeviceLimit ? 'cursor-not-allowed opacity-50' : ''}`}
                  style={{ fontFamily: 'inherit' }}
                >
                  <div
                    className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-none transition-colors duration-500"
              ...
              {displayedConnectionUrl && !shouldHideConnectionLink && (
                <div className="mb-5 flex gap-2">
                  <code
                    className="block min-w-0 flex-1 truncate whitespace-nowrap rounded-none px-3 py-2 font-mono text-[11px] text-dark-50/30"
                    style={{
                      background: g.codeBg,
                  ...
                  <button
                    onClick={copyUrl}
                    className="flex h-auto items-center rounded-none px-3 transition-colors duration-300"
                    style={{
                ...
                <div className="mb-5">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {subscription.servers.map((server) => (
                      <span
                        key={server.uuid}
                        className="inline-flex items-center gap-1.5 rounded-none px-2.5 py-1 text-[11px] font-medium text-dark-50/50"
                        style={{
        ...
        >
          <div
            className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-none"
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="rounded-none px-4 py-2 text-sm font-semibold transition-colors duration-300"
              style={{
                background:
        ...
        !subscription.is_trial && (
          ...
          >
            <button
              ...
              className="w-full rounded-none border border-warning-500/30 bg-warning-500/10 p-4 text-left transition-colors hover:bg-warning-500/20 disabled:opacity-50"
            >
              <div className="flex items-center justify-between">
                <div>
                      ...
                      <div className="min-w-0 flex-1">
                        {isEditing ? (
                          <input
                            ...
                            className="w-full rounded-none border-none bg-transparent px-2 py-1 text-sm font-semibold text-dark-50 outline-none focus:ring-1"
                            style={{
