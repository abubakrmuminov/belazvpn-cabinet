  ...
  return (
    <div className="min-h-viewport flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm text-center">
        {/* Logo */}
        <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center overflow-hidden rounded-none bg-gradient-to-br from-accent-400 to-accent-600 shadow-lg shadow-accent-500/30">
