  ...
  if (scriptFailed) {
    return (
      <div className="flex max-w-[200px] flex-col items-center gap-1.5">
        ...
        <button
          type="button"
          onClick={() => openLink(`https://t.me/${botUsername}`)}
  ...
  return (
    ...
    >
      ...
      <motion.div variants={staggerItem}>
        <PageHeader title={t('profile.accounts.title')} subtitle={t('profile.accounts.subtitle')} />
      </motion.div>
                    ...
                    <div className="mt-4 border-t border-dark-700/30 pt-4">
                      ...
                      {emailMergeCodePending ? (
                        <form onSubmit={handleVerifyMergeCode} className="space-y-3">
                          ...
                          {emailError && (
                            <div className="rounded-none border border-error-500/30 bg-error-500/10 p-3 text-sm text-error-400">
                              {emailError}
                            </div>
                          )}
                          {emailSuccess && (
                            <div className="rounded-none border border-success-500/30 bg-success-500/10 p-3 text-sm text-success-400">
                              {emailSuccess}
                            </div>
                          )}
                          <Button
