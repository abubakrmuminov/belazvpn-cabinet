    ...
    >
      ...
      <motion.div variants={staggerItem} className="flex items-center gap-3">
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-none border border-dark-700/30 bg-dark-800/50 text-dark-300 transition-colors hover:bg-dark-700/50 hover:text-dark-100"
        >
          <BackIcon className="h-5 w-5" />
        </button>
        <h1 className="font-mono text-2xl font-black uppercase tracking-tight text-dark-50 sm:text-3xl">
          ...
          <Card>
            <div className="space-y-3">
              {[1, 2].map((i) => (
                <div
                  key={i}
                  className="flex items-center justify-between rounded-none border border-dark-700/30 bg-dark-800/30 p-4"
                >
      ...
      {!isLoading && !isError && savedCards && savedCards.length > 0 ? (
        ...
        <motion.div variants={staggerItem}>
          <Card>
            <div className="py-12 text-center">
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-none bg-dark-800">
