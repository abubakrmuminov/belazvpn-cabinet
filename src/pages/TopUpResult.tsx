...
function AmountDisplay({ amountKopeks, label }: { amountKopeks: number; label: string }) {
  ...
  return (
    <div className="mt-4 rounded-none bg-dark-800/50 px-6 py-4">
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-none bg-dark-800/50 px-6 py-3 text-sm font-medium text-dark-200 transition-colors hover:bg-dark-700/50"
      >
    ...
    >
      ...
      <div className="flex w-full flex-col gap-3">
        <button
          type="button"
          onClick={onRetry}
          className="w-full rounded-none bg-accent-500 px-6 py-3 text-sm font-medium text-on-accent transition-colors hover:bg-accent-400"
        >
          {t('common.retry')}
        </button>
        <button
          type="button"
          onClick={onGoBack}
          className="w-full rounded-none bg-dark-800/50 px-6 py-3 text-sm font-medium text-dark-200 transition-colors hover:bg-dark-700/50"
        >
          {t('balance.topUpResult.goToBalance')}
        </button>
      </div>
