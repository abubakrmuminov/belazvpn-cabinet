...
function CodeOnlySuccessState({
  ...
  return (
    ...
    >
      ...
      {/* Gift code display */}
      <div className="w-full rounded-none border border-accent-500/20 bg-accent-500/5 p-4">
      ...
      <div className="w-full rounded-none border border-dark-700/30 bg-dark-800/40 p-4 text-left">
        ...
        {botLink && (
          <div className="mb-2">
            ...
            <p className="truncate rounded-none bg-dark-900/60 px-3 py-2 text-sm text-accent-400">
              {botLink}
            </p>
          </div>
        )}
      ...
      <button
        ...
        className="w-full rounded-none border border-dark-700/50 px-6 py-3 text-sm font-medium text-dark-300 transition-colors hover:bg-dark-800/50"
      >
...
function DeliveredState({
  ...
  return (
    ...
    >
      ...
      {warning && (
        <div className="w-full rounded-none border border-warning-500/20 bg-warning-500/5 p-3">
      ...
      <button
        type="button"
        onClick={() => navigate('/')}
        className="flex w-full items-center justify-center rounded-none bg-accent-500 px-6 py-3 text-sm font-medium text-on-accent transition-colors hover:bg-accent-400"
      >
