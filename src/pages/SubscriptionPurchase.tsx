      ...
      <div className="space-y-6">
        ...
        >
          ...
          <button
            ...
            className="rounded-none bg-accent-500 px-6 py-2 text-sm font-medium text-on-accent transition-colors hover:bg-accent-600"
          >
            {t('common.retry')}
          </button>
        </div>
      ...
      {isTariffsMode && tariffs.length > 0 && (
        ...
        >
          ...
          {subscription && !subscription.is_trial && !subscription.tariff_id && (
            <div className="mb-6 rounded-none border border-accent-500/30 bg-accent-500/10 p-4">
