...
export default function AutoLogin() {
  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-dark-950 px-4">
      <div className="w-full max-w-sm rounded-none border border-dark-800/50 bg-dark-900/50 p-8 text-center">
        {error ? (
          <div className="space-y-4">
            ...
            <button
              ...
              className="rounded-none bg-accent-500 px-6 py-2.5 text-sm font-medium text-on-accent transition-colors hover:bg-accent-400"
            >
              {t('auth.login', 'Login')}
            </button>
          </div>
