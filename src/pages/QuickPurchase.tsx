...
function ContactForm({
  ...
  return (
    <div className="space-y-4 rounded-none border border-dark-800/50 bg-dark-900/50 p-5">
      {/* Main contact */}
      <div>
        ...
        <input
          ...
          className="w-full rounded-none border border-dark-700/50 bg-dark-800/50 px-4 py-3 text-sm text-dark-50 placeholder-dark-500 outline-none transition-colors focus:border-accent-500/50 focus:ring-1 focus:ring-accent-500/25"
        />
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full resize-none rounded-none border border-dark-700/50 bg-dark-800/50 px-4 py-3 text-sm text-dark-50 placeholder-dark-500 outline-none transition-colors focus:border-accent-500/50 focus:ring-1 focus:ring-accent-500/25"
              />
            </div>
          </motion.div>
        )}
...
function TariffCard({
  ...
  return (
    <button
      ...
      onClick={onSelect}
      className={cn(
        'relative flex w-full flex-col rounded-none border p-5 text-start transition-all duration-200',
        isSelected
...
function SummaryCard({
  ...
  return (
    <div className="space-y-5">
      {/* Summary */}
      <div className="rounded-none border border-dark-800/50 bg-dark-900/50 p-5">
        {selectedTariff && (
          <div className="mb-3">
...
function TimeUnit({ value, label }: { value: number; label: string }) {
  return (
    <div className="flex flex-col items-center">
      <span className="flex h-10 w-10 items-center justify-center rounded-none bg-dark-800/80 text-lg font-bold tabular-nums text-dark-50 sm:h-12 sm:w-12 sm:text-xl">
...
function DiscountBanner({
  ...
  return (
    <motion.div
      ...
      animate={{ opacity: 1, y: 0 }}
      exit={{ opacity: 0, y: -10 }}
      className="mb-8 overflow-hidden rounded-none border border-accent-500/30 bg-gradient-to-r from-accent-500/10 via-accent-500/5 to-transparent"
    >
