...
export default function ChannelSubscriptionScreen() {
  ...
  return (
    ...
    >
      ...
      {channels.length > 0 && (
        <div className="space-y-2">
          {channels.map((ch) => (
            <div
              key={ch.channel_id}
              className="flex items-center justify-between gap-3 rounded-none border border-error-500/30 bg-error-500/10 p-3"
            >
      ...
      {/* Error message */}
      {error && (
        <div className="rounded-none border border-error-500/30 bg-error-500/10 p-3">
