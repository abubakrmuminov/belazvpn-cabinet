  ...
  ({ className, ...props }, ref) => (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        ...
        'rounded-none-lg border border-dark-700/50 bg-dark-900/95 backdrop-blur-linear',
  ...
  ({ className, inset, destructive, ...props }, ref) => {
    ...
    return (
      <DropdownMenuPrimitive.Item
        ref={ref}
        className={cn(
          'relative flex cursor-pointer select-none items-center gap-2 rounded-none px-2 py-2',
...
export const DropdownMenuCheckboxItem = forwardRef<HTMLDivElement, DropdownMenuCheckboxItemProps>(
  ({ className, children, checked, ...props }, ref) => (
    <DropdownMenuPrimitive.CheckboxItem
      ref={ref}
      className={cn(
        'relative flex cursor-pointer select-none items-center rounded-none py-2 pl-8 pr-2',
