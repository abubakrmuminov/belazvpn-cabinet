  ...
  const modalContent = (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div
        ...
        tabIndex={-1}
        className="relative mx-4 w-full max-w-sm overflow-hidden rounded-none border border-dark-700/50 bg-dark-900 shadow-2xl"
        style={{
      ...
      >
        ...
        <button
          ...
          className="absolute right-3 top-3 z-10 rounded-none p-2 text-dark-400 transition-colors hover:bg-dark-800 hover:text-dark-200"
        >
          <CloseIcon />
        </button>
        ...
        <div className="space-y-4 p-6">
          {/* Amount */}
          {formattedAmount && (
            <div className="flex items-center justify-between rounded-none bg-dark-800/50 px-4 py-3">
          ...
          {/* Tariff name */}
          {data.tariffName && (
            <div className="flex items-center justify-between gap-3 rounded-none bg-dark-800/50 px-4 py-3">
          ...
          <div className="space-y-2 pt-2">
            {isSubscription && (
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-none bg-accent-500 py-3.5 font-bold text-on-accent shadow-lg shadow-accent-500/25 transition-colors hover:bg-accent-400 active:bg-accent-600"
              >
            ...
            {isBalanceTopup && (
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-none bg-success-500 py-3.5 font-bold text-white shadow-lg shadow-success-500/25 transition-colors hover:bg-success-400 active:bg-success-600"
              >
            ...
            <button
              onClick={handleClose}
              className="w-full rounded-none bg-dark-800 py-3 font-semibold text-dark-300 transition-colors hover:bg-dark-700 hover:text-dark-100"
            >
