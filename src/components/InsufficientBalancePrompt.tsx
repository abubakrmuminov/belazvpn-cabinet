...
export default function InsufficientBalancePrompt({
  ...
  if (compact) {
    return (
      <div
        className={`flex items-center justify-between gap-3 rounded-none border border-error-500/30 bg-error-500/10 p-3 ${className}`}
      >
  ...
  return (
    <div
      className={`rounded-none border border-error-500/30 bg-gradient-to-br from-error-500/10 to-warning-500/5 p-4 ${className}`}
    >
      <div className="flex items-start gap-3">
        <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-none bg-error-500/20">
