...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
        ...
        <div className="min-h-viewport flex items-center justify-center bg-dark-900 p-4">
          <div className="max-w-md text-center">
            ...
            <button
              ...
              className="rounded-none bg-accent-500 px-6 py-3 font-medium text-on-accent transition-colors hover:bg-accent-600"
            >
              Reload page
            </button>
          </div>
    ...
    if (level === 'widget') {
      return (
        <div className="rounded-none border border-error-500/30 bg-error-500/10 p-4 text-center">
