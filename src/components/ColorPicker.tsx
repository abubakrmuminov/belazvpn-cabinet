...
export function ColorPicker({ value, onChange, label, description, disabled }: ColorPickerProps) {
  ...
  const pickerContent = isOpen ? (
    <div
      ref={pickerRef}
      className="fixed z-[9999] w-[280px] overflow-hidden rounded-none border border-dark-700 bg-dark-900 shadow-2xl"
      style={{
      ...
      <div className="space-y-4 p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="h-9 flex-1 rounded-none border border-dark-700 bg-dark-800 px-3 font-mono text-sm uppercase text-dark-100 focus:border-accent-500 focus:outline-none"
            placeholder="#000000"
            maxLength={7}
          />
        </div>
          ...
          <div className="grid grid-cols-6 gap-1.5">
            {PRESET_COLORS.map((preset) => (
              <button
                ...
                className={`aspect-square w-full rounded-none transition-transform hover:scale-110 active:scale-95 ${
    ...
    <div className="relative min-w-0 overflow-hidden">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          onClick={handleOpen}
          disabled={disabled}
          className="h-10 w-10 flex-shrink-0 rounded-none border-2 border-dark-700 shadow-inner transition-all hover:scale-105 hover:border-dark-600 disabled:cursor-not-allowed disabled:opacity-50"
        ...
        <input
          ...
          onChange={handleHexInputChange}
          disabled={disabled}
          className="h-10 min-w-0 flex-1 rounded-none border border-dark-700 bg-dark-800 px-2 font-mono text-sm uppercase text-dark-100 focus:border-accent-500 focus:outline-none disabled:opacity-50"
          placeholder="#000000"
          maxLength={7}
        />
      </div>
