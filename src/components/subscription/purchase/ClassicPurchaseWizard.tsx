          ...
          {currentStep === 'confirm' && (
            <div>
              {previewLoading ? (
                ...
                <div className="space-y-4 rounded-none bg-dark-800/50 p-5">
                  {activeDiscount?.is_active && activeDiscount.discount_percent && (
                    <div className="flex items-center justify-center gap-2 rounded-none border border-warning-500/30 bg-warning-500/10 p-3">
                      <svg
                  ...
                  {!preview.can_purchase &&
                    (preview.missing_amount_kopeks > 0 ? (
                      ...
                      <div className="rounded-none bg-error-500/10 px-4 py-3 text-center text-sm text-error-400">
                        {preview.status_message}
                      </div>
                    ) : null)}
                </div>
