...
export function TariffPurchaseForm({
  ...
  const sbpPurchaseButton = sbpPurchaseEnabled && (
    <>
      <button
        ...
        className="mt-2 w-full rounded-none border border-accent-500/40 bg-accent-500/10 py-3 text-sm font-medium text-accent-400 transition-colors hover:bg-accent-500/20 disabled:opacity-50"
      >
  ...
  return (
    <div ref={ref} className="space-y-6">
      ...
      {/* Tariff Info */}
      <div className="rounded-none bg-dark-800/50 p-4">
      ...
      {tariff.is_daily || (tariff.daily_price_kopeks && tariff.daily_price_kopeks > 0) ? (
        <div className="rounded-none border border-accent-500/30 bg-accent-500/10 p-5">
        ...
        <>
          ...
          <div>
                ...
                {tariff.periods.map((period) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative rounded-none p-4 text-left transition-all ${
            ...
            {tariff.periods.length === 0 &&
              ...
              !(tariff.custom_days_enabled && (tariff.price_per_day_kopeks ?? 0) > 0) && (
                <div className="rounded-none border border-warning-500/30 bg-warning-500/10 p-4 text-center">
            ...
            {/* Custom days option */}
            {tariff.custom_days_enabled && (tariff.price_per_day_kopeks ?? 0) > 0 && (
              <div className="rounded-none border border-dark-700/50 bg-dark-800/50 p-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-4">
                      ...
                      <input
                        ...
                        className="w-20 rounded-none border border-dark-600 bg-dark-700 px-3 py-2 text-center text-dark-100"
                      />
                    </div>
                    {(() => {
          ...
          {(selectedTariffPeriod || useCustomDays) && (
            <div className="rounded-none bg-dark-800/50 p-5">
              {(() => {
                ...
                return (
                  <>
                    ...
                    {promoPeriod.percent && (
                      <div className="mb-4 flex items-center justify-center gap-2 rounded-none border border-warning-500/30 bg-warning-500/10 p-2">
