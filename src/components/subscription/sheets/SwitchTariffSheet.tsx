...
export function SwitchTariffSheet({
  ...
  return (
    <div ref={ref} className="mb-6 space-y-4 rounded-none bg-dark-800/50 p-5">
        ...
        (() => {
          ...
          return (
            <>
              ...
              {isDailyTariff && (
                <div className="rounded-none border border-accent-500/30 bg-accent-500/10 p-3 text-center">
