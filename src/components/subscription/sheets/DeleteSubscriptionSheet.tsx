...
export function DeleteSubscriptionSheet({
  ...
  if (!open) {
    return (
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-none border border-error-400/20 bg-error-400/5 p-3.5 text-sm font-medium text-error-400 transition-colors hover:bg-error-400/10 disabled:opacity-50"
      >
  ...
  return (
    <div
      className="rounded-none border border-error-400/20 p-4"
    ...
    >
      ...
      <div className="flex gap-2">
        <button
          ...
          disabled={deleteLoading}
          className="flex-1 rounded-none bg-error-500 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-error-600 disabled:opacity-50"
        >
          {deleteLoading
        ...
        <button
          onClick={onClose}
          className="flex-1 rounded-none border border-dark-700 py-2.5 text-sm font-medium transition-colors hover:bg-dark-700"
