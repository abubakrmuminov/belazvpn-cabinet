  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className={`touch-target flex items-center gap-1.5 rounded-none border px-2.5 py-2 text-sm transition-all ${
          isOpen
      ...
      {isOpen && (
        <div className="absolute right-0 z-50 mt-2 w-40 animate-fade-in rounded-none border border-dark-700/50 bg-dark-800 py-1 shadow-lg">
