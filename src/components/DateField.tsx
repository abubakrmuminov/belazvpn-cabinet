    ...
    <Popover.Root open={open} onOpenChange={setOpen}>
      <Popover.Trigger asChild>
        <button
          ...
          className={
            className ??
            'flex min-w-[8rem] items-center justify-start gap-2 whitespace-nowrap rounded-none border border-dark-600 bg-dark-800 px-3 py-1.5 text-sm text-dark-200 transition-colors hover:border-dark-500'
          }
        >
      ...
      <Popover.Portal>
        <Popover.Content
          ...
          sideOffset={6}
          collisionPadding={8}
          className="rdp-dark z-50 max-w-[calc(100vw-1rem)] rounded-none border border-dark-700 bg-dark-800 p-2 shadow-xl"
        >
          <DayPicker
            mode="single"
            locale={locale}
