  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className={`touch-target relative flex items-center justify-center rounded-none border p-2 transition-all duration-200 ${
          isOpen
      ...
      {isOpen && (
        <div
          className="fixed left-4 right-4 z-50 mt-0 w-auto animate-scale-in overflow-hidden rounded-none border border-dark-700/50 bg-dark-900/95 shadow-2xl shadow-black/30 backdrop-blur-xl sm:absolute sm:left-auto sm:right-0 sm:top-auto sm:mt-2 sm:w-96"
          ...
          <div className="max-h-80 overflow-y-auto">
            {isLoading ? (
              ...
              notificationsData.items.map((notification: TicketNotification) => (
                ...
                >
                  <div className="flex gap-3">
                    <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-none bg-dark-800/50">
              ...
              <div className="p-8 text-center">
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-none bg-dark-800/50 text-dark-500">
                  <BellIcon />
                </div>
