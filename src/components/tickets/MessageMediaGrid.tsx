          ...
          {visiblePhotos.map((item, visIdx) => {
            ...
            return (
              <button
                ...
                type="button"
                className="group relative aspect-square overflow-hidden rounded-none bg-dark-800"
      ...
      {otherItems.map((item) => {
          ...
          return (
            <div key={item.file_id}>
              <video
                src={mediaUrl}
                controls
                className="max-h-64 max-w-full rounded-none"
                preload="metadata"
              />
        ...
        return (
          <a
            ...
            className="inline-flex items-center gap-2 rounded-none bg-dark-700 px-3 py-2 text-sm text-dark-200 transition-colors hover:bg-dark-600"
          >
